...
import { installAgent, isKind, removeAgent, type InstalledAgent } from "./agents.js";
 ...
 */
let installedAgent: InstalledAgent | undefined;

function agentTeardown(): void {
  if (installedAgent === undefined) return;
